package com.gy.lease.web.admin.controller.login;
...
public class LoginController {
    ...
    public Result<SystemUserInfoVo> info() {
        ...
        SystemUserInfoVo systemUserInfoVo = loginService.getInfoByToken(LoginUserHolder.getLoginUser().getUserId());
